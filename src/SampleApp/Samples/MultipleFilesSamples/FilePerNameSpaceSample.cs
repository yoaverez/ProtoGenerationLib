...
{
    public class FilePerNameSpaceSample : ISampleRunner
    {
        public void RunSample()
        {
            ...
            // Set the file naming strategy to name space.
            generationOptions.ProtoNamingStrategiesOptions.FileNamingStrategy =
                StrategyNamesLookup.FilePathStrategiesLookup[FilePathStrategyKind.NameSpace];
