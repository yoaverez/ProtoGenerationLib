...
{
    public class FilePerNameSpaceAndTypeSample : ISampleRunner
    {
        public void RunSample()
        {
            ...
            // Set the file naming strategy to name space and type name.
            generationOptions.ProtoNamingStrategiesOptions.FileNamingStrategy =
                StrategyNamesLookup.FilePathStrategiesLookup[FilePathStrategyKind.NameSpaceAndTypeName];
