...
namespace SampleApp.Samples.CustomizationsSamples
{
    public class AddCustomDocumentationSample : ISampleRunner
    {
        ...
        public void RunSample()
        {
            ...
            generationOptions.AddMethodDocumentation<IContractType>(nameof(IContractType.Method1), 0, "Method1 documentation.");
            generationOptions.AddMethodDocumentation<IContractType>(nameof(IContractType.Method2), 1, "A second method that shows how the documentation customization works.");
