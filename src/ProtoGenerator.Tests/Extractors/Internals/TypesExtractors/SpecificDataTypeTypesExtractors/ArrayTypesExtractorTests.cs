...
{
    [TestClass]
    public class ArrayTypesExtractorTests
    {
        ...
        public void TestInitialize()
        {
            ...
            extractor = new ArrayTypesExtractor(mockINewTypeNamingStrategiesProvider.Object);
        }
        ...
        {
            var testClassName = nameof(ArrayTypesExtractorTests);
            return new List<object[]>
            {
                new object[] { typeof(int[]), new List<string> { $"{testClassName}1", typeof(int).Name } },
                new object[] { typeof(string[][][]), new List<string> { $"{testClassName}2", typeof(string).Name } },
                new object[] { typeof(bool[,,,,]), new List<string> { $"{testClassName}3", typeof(bool).Name } },
            };
        }
