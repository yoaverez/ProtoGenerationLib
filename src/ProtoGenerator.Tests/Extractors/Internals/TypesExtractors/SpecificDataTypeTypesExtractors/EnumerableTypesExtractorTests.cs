...
{
    [TestClass]
    public class EnumerableTypesExtractorTests
    {
        private EnumerableTypesExtractor extractor;
        ...
        public void TestInitialize()
        {
            ...
            extractor = new EnumerableTypesExtractor(mockINewTypeNamingStrategiesProvider.Object);
        }
        ...
        {
            var testClassName = nameof(EnumerableTypesExtractorTests);
            return new List<object[]>
            {
                new object[] { typeof(Dictionary<int, string>), new List<string> { $"{testClassName}1", typeof(KeyValuePair<int, string>).Name } },
                new object[] { typeof(List<char>), new List<string> { $"{testClassName}2", typeof(char).Name } },
                new object[] { typeof(IEnumerable<double>), new List<string> { $"{testClassName}3", typeof(double).Name } },
            };
        }
