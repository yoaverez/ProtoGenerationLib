...
{
    [TestClass]
    public class NullableTypeReplacerTests
    {
        private NullableTypeReplacer replacer;
        ...
        public void TestInitialize()
        {
            ...
            replacer = new NullableTypeReplacer(mockINewTypeNamingStrategiesProvider.Object);
        }
        ...
        {
            var testClassName = nameof(NullableTypeReplacerTests);
            return new List<object[]>
            {
                new object[] { typeof(bool?), $"{testClassName}1" },
                new object[] { typeof(char?), $"{testClassName}2" },
            };
        }
