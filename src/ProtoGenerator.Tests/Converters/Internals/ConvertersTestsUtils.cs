...
namespace ProtoGenerator.Tests.Converters.Internals
{
    internal static class ConvertersTestsUtils
    {
        ...
        public static DataTypeMetadata CreateDataTypeMetadata(Type type, IEnumerable<IFieldMetadata> fields, IEnumerable<IDataTypeMetadata> nestedDataTypes, IEnumerable<IEnumTypeMetadata> nestedEnumTypes)
        {
